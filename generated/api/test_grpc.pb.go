...
const (
	TestService_SayHello_FullMethodName = "/api.TestService/SayHello"
)
...
func (c *testServiceClient) SayHello(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
...
func (UnimplementedTestServiceServer) SayHello(context.Context, *TestRequest) (*TestResponse, error) {
...
func _TestService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServiceServer).SayHello(ctx, req.(*TestRequest))
	}
